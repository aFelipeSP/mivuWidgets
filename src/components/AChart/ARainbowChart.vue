<template>
<div class="a-rainbow-chart">
  <div class="a-rainbow-chart-legend">
    <div
  ...
  <div class="a-rainbow-chart-box" ref="svg">
    <svg width="100%" height="100%">
      ...
      <g v-for="(slice) in data_" :key="slice.index"
        :transform="
          ...
          `translate(${svgWidth/2}, ${svgHeight/2}) scale(1.05)` +
      ...
      <circle
        :cx="svgWidth/2" :cy="svgHeight/2" :r="Math.min(svgWidth/2, svgHeight/2)/2"
        fill="white"
      />
    </svg>
  </div>
